...
contextBridge.exposeInMainWorld("obserraOwner", {
  ...
  getAcademyControlSnapshot: () => ipcRenderer.invoke("academy:getControlSnapshot"),
  updateAcademyReview: (payload) => ipcRenderer.invoke("academy:updateReview", payload),
  transitionAcademyCourse: (payload) => ipcRenderer.invoke("academy:transitionCourse", payload),
  ...
  getAcademyControlLedger: (limit) => ipcRenderer.invoke("academy:getControlLedger", limit),
  ...
  runAcademyAction: (payload) => ipcRenderer.invoke("academy:runControlledAction", payload),
