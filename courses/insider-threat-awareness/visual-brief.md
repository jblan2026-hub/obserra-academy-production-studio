...
# Visual Production Brief: Insider Threat Awareness for Leaders
...
- Module 1: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Decision context: Insider Threat Awareness for Leaders**.
- Module 2: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Evidence and risk: risk-aware people, data, and access decisions without unsupported accusations**.
- Module 3: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Control and authority: risk-aware people, data, and access decisions without unsupported accusations**.
- Module 4: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Scenario practice: risk-aware people, data, and access decisions without unsupported accusations**.
- Module 5: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Action and improvement: risk-aware people, data, and access decisions without unsupported accusations**.
