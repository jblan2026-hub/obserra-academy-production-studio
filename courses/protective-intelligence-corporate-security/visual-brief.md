...
# Visual Production Brief: Protective Intelligence for Corporate Security Teams
...
Use only the owner-approved official Obserra logo at `brand/assets/obserra-official-logo.png` and the official black, dark navy, gold, light gold, restrained holographic blue, and white visual system. No generic substitute marks are permitted.

## Mandatory legal display

- Display "For educational and informational purposes only. Not certification, compliance validation, or professional advice." on the opening screen or course description.
...
- Module 1: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Decision context: Protective Intelligence for Corporate Security Teams**.
- Module 2: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Evidence and risk: protective intelligence analysis, threat indicators, and safe operational recommendations**.
- Module 3: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Control and authority: protective intelligence analysis, threat indicators, and safe operational recommendations**.
- Module 4: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Scenario practice: protective intelligence analysis, threat indicators, and safe operational recommendations**.
- Module 5: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Action and improvement: protective intelligence analysis, threat indicators, and safe operational recommendations**.
