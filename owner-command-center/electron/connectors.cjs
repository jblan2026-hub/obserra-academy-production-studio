const APPROVED_CONNECTORS = Object.freeze([
  { id: "lcms", name: "Academy LCMS", description: "Courses, production queues, releases, audit activity, and system health.", env: "OBSERRA_LCMS_URL", defaultUrl: "https://studio.obserra.example", healthPath: "/api/health", credentialKey: "lcmsToken", control: true },
  { id: "academy", name: "Obserra Academy", description: "Learners, enrollments, course delivery, assessments, and completion records.", env: "OBSERRA_ACADEMY_URL", defaultUrl: "https://academy.obserra.example", healthPath: "/api/health", credentialKey: "academyToken", control: true },
  { id: "website", name: "Obserra Website", description: "Public website, catalog synchronization, deployments, and application health.", env: "OBSERRA_WEBSITE_URL", defaultUrl: "https://www.obserrrallc.com", healthPath: "/api/health", credentialKey: "websiteToken", control: true },
  { id: "store", name: "Obserra Store", description: "Products, orders, licensing, entitlements, and marketplace synchronization.", env: "OBSERRA_STORE_URL", defaultUrl: "https://www.obserrrallc.com", healthPath: "/api/health", credentialKey: "storeToken", control: true },
