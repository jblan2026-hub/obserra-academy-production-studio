export type BackendAuthProvider = "supabase" | "clerk" | "machine-only";
...
export const backendConfig = Object.freeze({
  ...
  authProvider: enumValue<BackendAuthProvider>("STUDIO_AUTH_PROVIDER", ["supabase", "clerk", "machine-only"], "supabase"),
