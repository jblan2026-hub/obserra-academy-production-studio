const APPROVED_CONNECTORS = Object.freeze([
  ...
  { id: "eios", name: "Obserra EIOS", description: "Enterprise intelligence, governed features, evidence, recommendations, runtime mode, and platform health.", env: "OBSERRA_EIOS_URL", defaultUrl: "https://obserra-eios-console.vercel.app", healthPath: "/api/health", intelligencePath: "/api/obserra/intelligence", credentialKey: "eiosToken", control: true, aiReporting: true },
  ...
  { id: "vercel", name: "Vercel", description: "Website, Academy, and EIOS deployment status, build logs, domains, and project health.", env: "VERCEL_API_URL", defaultUrl: "https://api.vercel.com", healthPath: "/v2/user", intelligencePath: null, credentialKey: "vercelToken", control: true, aiReporting: false },
