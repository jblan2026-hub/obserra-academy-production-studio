...
# Visual Production Brief: Identity Security and Access Governance
...
- Module 1: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Decision context: Identity Security and Access Governance**.
- Module 2: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Evidence and risk: identity lifecycle governance, least privilege, and access-risk reduction**.
- Module 3: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Control and authority: identity lifecycle governance, least privilege, and access-risk reduction**.
- Module 4: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Scenario practice: identity lifecycle governance, least privilege, and access-risk reduction**.
- Module 5: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Action and improvement: identity lifecycle governance, least privilege, and access-risk reduction**.
