...
contextBridge.exposeInMainWorld("obserraOwner", {
  ...
  getAcademyCourseReview: (courseId) => ipcRenderer.invoke("academy:getCourseReview", courseId),
  getAcademyCourseMedia: (payload) => ipcRenderer.invoke("academy:getCourseMedia", payload),
  recordAcademyCourseDecision: (payload) => ipcRenderer.invoke("academy:recordCourseDecision", payload),
