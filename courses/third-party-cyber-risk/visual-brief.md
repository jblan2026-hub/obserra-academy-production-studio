...
# Visual Production Brief: Third Party and Supply Chain Cyber Risk
...
- Module 1: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Decision context: Third Party and Supply Chain Cyber Risk**.
- Module 2: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Evidence and risk: supplier risk, concentration exposure, control validation, and accountable escalation**.
- Module 3: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Control and authority: supplier risk, concentration exposure, control validation, and accountable escalation**.
- Module 4: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Scenario practice: supplier risk, concentration exposure, control validation, and accountable escalation**.
- Module 5: branded opening visual, explanatory diagram, scenario visual, and decision-summary visual for **Action and improvement: supplier risk, concentration exposure, control validation, and accountable escalation**.
